...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{asset('dashboard/assets/css/noty.min.css')}}">
        <script src="{{asset('dashboard/assets/js/noty.min.js')}}"></script>
                                ...
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="section-header">
                                        ...
                                        <ul id="filter-list" class="clearfix">
                                            ...
                                            <li class="filter" data-filter="#{{ $cat->slug }}">
                                                {{ $cat->name }}
                                            <span class="badge">{{ $cat->item->count() }}</span>
                                            </li>
                                            @endforeach
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            <ul id="menu-pricing" class="menu-price">
                                @foreach ($items as $item)
                                    ...
                                    <a href="#">
                                        <img src="{{ asset('uploads/item/'. $item->image)}}" class="img-responsive" alt="Food"  style="height: 300px; width: 369px;">
                                ...
                                <form class="reservation-form" method="post" action="{{ route('reserve') }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control reserve-form empty iconified" name="date_time" id="datetimepicker" placeholder="&#xf017;  Time">
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                             <form class="contact-form" method="post" action="{{ route('contact') }}">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <input name="phone" type="phone" class="form-control" id="phone" required="required" placeholder="  Phone">
                                    </div>
                                    <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="copyright text-center">
                            <p>
                                &copy; Copyright, 2021 by <a href="https://www.linkedin.com/in/muhammad-tanvir-hasan/"  target="_blank">Muhammad Tanvir Hasan</a>
                            </p>
                        </div>
                    </div>
                </div>
