    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Slider Edit</h4>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.slider.update',$slider->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12 col-sm-12">
                                <label for="image">Slider Image</label>
                                    ...
                                    @if (!is_null($slider->image))
                                        <img src="{{ asset('uploads/slider/'. $slider->image)}}" style="width: 80px" alt="">
                                    @endif 
                                   </p>
                     ...
                     <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4">Edit Slider</button>
