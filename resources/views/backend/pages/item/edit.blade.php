        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><a href="{{ route('admin.item.index') }}">All Item</a></li>
                    ...
                    <form action="{{ route('admin.item.update',$item->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="col-md-12 col-sm-12">
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="Enter Item Title" value="{{ $item->name }}">
                            </div>
                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <input type="number" class="form-control" id="price" name="price" placeholder="Enter Item Price" value="{{ $item->price }}">
                            </div>
                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <p>
                                    @if (!is_null($item->image))
                                        <img src="{{ asset('uploads/item/'. $item->image)}}" style="width: 80px" alt="">
                                    @endif 
                                   </p>
                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <textarea name="description" class="form-control" cols="10" rows="5">{{ $item->description }}</textarea>
                            </div>
